...
The documents are semantically annotated and linked across languages by using a cross-lingual similarity measure. Within each monolingual stream, an online
clustering approach is employed, where tracked clusters correspond to events. Finally, using 
  
  and using the cross-lingual techniques  as well as processed using standard text mining techniquesBy using an online clustering approach
