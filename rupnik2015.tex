...
The goal of this work is to examine how well events can be tracked in a multilingual reporting environment. Since this, represents complicated pipeline, we concentrate on two specific elements, namely multilingual similarity of articles and event linking using this similarity. Overall, these should be considered from a systems perspective (considering the system as a whole) rather than considering these problems in isolation. 
