...
\subsection{Hub languages}\label{sec:hublang}

In this section, we describe an extension to CCA, which is more applicable to a large number of languages. The main difficulty with applying the
